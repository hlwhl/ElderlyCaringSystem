...
public class SignupActivity extends AppCompatActivity {
    ...
    @BindView(R.id.input_address) EditText sensorAdd;
    ...
    @BindView(R.id.input_usertype) RadioGroup rg_usertype;
    ...
    public void signup() {
        ...
        int usertype=0;
        if(rg_usertype.equals(R.id.type_ward)){
            usertype=1;
        }
    ...
    public boolean validate() {
        ...
        if (address.isEmpty()) {
            sensorAdd.setError("Enter Valid Address");
            valid = false;
        } else {
            sensorAdd.setError(null);
        }
